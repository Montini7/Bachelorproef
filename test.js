module.exports = [
  ...
  },
  {
    id: 5,
    description:
      "A lot of time has elapsed, but still no MVP. Maybe PHP wasn't the way to go...",
    character: '',
  ...
  },
  {
    id: 13,
    description:
      'One of our employees left their unlocked phone at a bar. This is a serious security breach',
  ...
  },
  {
    id: 14,
    description:
      "We've been working on a mobile app for 3 months but it's still not ready.",
  ...
  },
  {
    id: 16,
    description:
      'I wanna invest in your startup - but you have to step down as CEO.',
  ...
  },
  {
    id: 19,
    description:
      'I want to use your blood in my longevity experiment in exchange for investment.',
  ...
  },
  {
    id: 21,
    description:
      'Users are complaining about one of our rude support employees.',
  ...
  },
  {
    id: 22,
    description:
      'Your best friend just got an MBA and wants to join your company in BizDev.',
    character: 'assistant',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 39,
    description:
      "Cash flow is down and you're too busy pinching pennies to look for a new funding round.",
    character: 'cfo',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 42,
    description:
      "We know that there's this important deadline coming up but it's Thanksgiving and we want to go home.",
    character: 'tanya-frontend, victor-frontend',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 45,
    description:
      'Your company offers no health insurance. 2 employees just died of Pneumonia.',
  ...
  },
  {
    id: 46,
    description:
      'Your company still offers no health insurance. An employee just died of Syphilis.',
    character: 'bad-consequence',
  ...
  },
  {
    id: 49,
    description:
      "The codebase is a mess and we're fighting the platform every inch of the way...",
    character: 'tanya-frontend, victor-frontend',
  ...
  },
  {
    id: 50,
    description:
      'Thanks for letting us switch platforms. The rewrite is coming along really well!',
    character: 'tanya-frontend, victor-frontend',
  ...
  },
  {
    id: 52,
    description:
      'Zesty offers you a deal to cater lunches to your office, for a mere $200 a day!',
    character: 'office-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 55,
    description:
      "You've been completely ignoring us for the past month and we're really pissed off.",
    character: 'vc-fred, vc-mike',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 57,
    description:
      'Another app with the same name just appeared. Apparently they have a trademark and everything...',
    character: 'product-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 59,
    description:
      'You remember you have a pitch coming up early tomorrow morning, right?',
    character: 'assistant',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 60,
    description:
      'You stayed up late preparing. You overslept and missed the presentation.',
    character: '',
  ...
  },
  {
    id: 65,
    description:
      'One of our account managers just told a client to eat dog shit...',
    character: 'support-01',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 67,
    description:
      'Transparency is so hot right now - can I do a blog post about our growth data?',
    character: 'chad-marketing',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 68,
    description:
      'Your significant other is having an affair with one of your investors.',
    character: 'vc-fred, vc-mike',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 70,
    description:
      'The cops busted our Christmas party - seems there was something special in the punch.',
    character: 'office-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 72,
    description:
      "We're about to raise series A funding. Where are those documents you promised?",
    character: 'cfo',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 75,
    description:
      "A former employee wrote a book bashing you and the company. Everybody's reading it!",
    character: 'chad-marketing',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 76,
    description:
      "One of your employees has been living in the office because they can't pay rent.",
    character: 'office-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 77,
    description:
      "Your developers want to bring go-go dancers to a conference event we're hosting.",
    character: 'office-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 80,
    description:
      'One of your ex-employees went to the press saying you spend all your days googling yourself.',
    character: 'journalist',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 81,
    description:
      'A Chinese company copied our design and has just filed for an IPO!',
    character: 'product-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 85,
    description:
      "My first song made it to no. 1 - and it's named after your startup!",
    character: 'rapper-02',
  ...
  },
  {
    id: 86,
    description:
      'I crashed the company Cadillac into a police car. On purpose.',
    character: 'rapper-03',
  ...
  },
  {
    id: 87,
    description:
      'Google just announced an exact copy of our product and made all their users sign up.',
    character: 'product-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 88,
    description:
      'You hear gossip that one of your investors is bashing you to other investors.',
    character: 'vc-fred, vc-mike',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 89,
    description:
      "Changes to our partner's Terms of Service just killed our most important integration.",
    character: 'product-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 90,
    description:
      "I'll give you 10 million dollars if you agree to share offices with my Initech team.",
    character: 'richard-branson',
  ...
  },
  {
    id: 95,
    description:
      'Bitcoin market crashes, your 1000 bitcoins are now worth $46.',
    character: 'cfo',
  ...
  },
  {
    id: 97,
    description:
      'Private emails between you and a former investor end up in the press.',
    character: 'journalist',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 98,
    description:
      "Your co-founder gets a divorce and doesn't show up to work for a week.",
    character: 'office-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 100,
    description:
      'I got a buddy working for Shark Tank - we should put together a crazy pitch!',
    character: 'vc-raiden',
  ...
  },
  {
    id: 101,
    description:
      'We caught an employee copying company files to their private Dropbox.',
    character: 'product-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 102,
    description:
      'Our user data got wiped! Luckily an employee had a backup in Dropbox.',
    character: 'product-manager',
  ...
  },
  {
    id: 108,
    description:
      'Your lead developer calls you a n00b in front of the whole team.',
    character: 'tanya-frontend, victor-frontend',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 109,
    description:
      "You still haven't used your 7 days of mandatory vacation this year.",
    character: 'office-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 113,
    description:
      'I just bought Snapchat spectacles for the whole team with company money. Rad!',
    character: 'chad-marketing',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 114,
    description:
      "I've found 249 conflicts after â€˜git merge develop masterâ€™ and it's three days before deadline.",
    character: 'tanya-frontend, victor-frontend',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 115,
    description:
      'A bunch of tech writers will be at this party tonight. Are you coming?',
    character: 'chad-marketing',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 116,
    description:
      'You get drunk, hit on every person in the room and end up being banned from TechCrunch forever.',
    character: 'journalist',
  ...
  },
  {
    id: 118,
    description:
      "People love our product, but I think it's because we're cheap. Should we raise the price?",
    character: 'product-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 119,
    description:
      'It turns out our app\'s name means "dick" in Japanese, what do we do?',
    character: 'product-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 126,
    description:
      'Chad brought a dog to the office, but 2 other employees are allergic.',
    character: 'office-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 128,
    description:
      "The Black Friday campaign is all set up but the discount codes don't work.",
    character: 'backend-dev-01',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 129,
    description:
      'Black Friday traffic has crashed our website and the developers are out shopping!',
    character: 'support-01',
  ...
  },
  {
    id: 132,
    description:
      'Our revenue is skyrocketing! But now we have to pay more taxes.',
    character: 'cfo',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 139,
    description:
      'Twitter is enraged because you bragged about your "all-man wreckin\' crew".',
    character: 'support-01',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 140,
    description:
      'Our employees are spending too much money on business travel.',
    character: 'cfo',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 141,
    description:
      "You got featured in Business Insider and it's driving tons of traffic to us!",
    character: 'chad-marketing',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 142,
    description:
      'You come up with a cool new business idea and make tons of money.',
  ...
  },
  {
    id: 143,
    description:
      'Chad showed up at work in a tank top again. Should we enforce a formal dress code?',
    character: 'office-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 146,
    description:
      'Three of our key employees want to go on a sabbatical... together.',
    character: 'product-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 147,
    description:
      "We need to collect more e-mails for leads. I'm thinking full-page pop ups - EVERYWHERE.",
    character: 'chad-marketing',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 148,
    description:
      "You're invited to a gala but all you own are black turtlenecks and jeans.",
  ...
  },
  {
    id: 150,
    description:
      'Techcrunch wants to do a story about your company but you have to publish all your business data and investors advise you not to do it.',
    character: 'journalist',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 151,
    description:
      'I want to build a startup game as a side-project - with our upsell, of course.',
    character: 'chad-marketing',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 152,
    description:
      'Chad quit to start a game studio, he took half our team with him!',
    character: 'product-manager',
  ...
  },
  {
    id: 155,
    description:
      "There's a new overtime law and you have to raise salaries or hire more people to avoid paying higher overtime wages.",
    character: 'cfo',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 156,
    description:
      "We've moved our website to the hosting server but I'm still seeing the â€œComing Soonâ€ page.",
    character: 'backend-dev-01',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 157,
    description:
      'Just got a call from the landlord - office rent is going up starting next month.',
    character: 'cfo',
  ...
  },
  {
    id: 158,
    description:
      "Your app's on ProductHunt today, Ryan Hoover tweets it with a :shrug: emoji.",
    character: 'seo-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 159,
    description:
      'Your angry tweets have been seen by Donald Trump. He wants to invest!',
  ...
  },
  {
    id: 162,
    description:
      'The offer is withdrawn at the last moment. Are we that terrible?',
    character: 'cfo',
  ...
  },
  {
    id: 163,
    description:
      'Recruiters have been sending aggressive emails to my engineers.',
    character: 'product-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 165,
    description:
      'Some users are asking for refunds after our service was down for an hour.',
    character: 'roy-sales',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 168,
    description:
      'I heard an ex-employee is using our client list to promote their new product.',
    character: 'product-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 169,
    description:
      'Local startup club wants you to become a mentor to new startup founders.',
    character: 'vc-raiden',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 170,
    description:
      'We need to find alternative monetization options for our product.',
    character: 'product-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 171,
    description:
      'Customers are asking for phone support. Should we give them our number?',
    character: 'support-01',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 176,
    description:
      'One of the clients is demanding to "speak to a manager" about our refund policy.',
    character: 'support-01',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 178,
    description:
      "SXSW wants us to sponsor the event with $75,000, and they'll offer 6 banners and a website link in return.",
    character: 'chad-marketing',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 183,
    description:
      "We should buy some print advertising, It'll be cheap, I promise",
    character: 'chad-marketing',
    conditions: 'beforeWeek(2)',
    choices: {
      a: {
  ...
  },
  {
    id: 186,
    description:
      'New customers have a hard time finding the key features our product.',
    character: 'support-01',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 189,
    description:
      "A customer says your company's Google+ page is not up to date.",
    character: 'support-01',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 192,
    description:
      "The White House started to use our product but we can't publish this information.",
    character: 'chad-marketing',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 193,
    description:
      'Somebody has registered a Twitter handle with your company name already but they have 0 followers.',
    character: 'product-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 194,
    description:
      'Airbnb starts to use your product and wants to do a cross-promotion with you.',
    character: 'product-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 196,
    description:
      'Good news! We just moved into our new office and things are looking bright.',
    character: 'office-manager',
  ...
  },
  {
    id: 199,
    description:
      'An old friend comes to you with a cool new startup idea and wants you to be the cofounder.',
    character: 'assistant',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 206,
    description:
      "I just checked our company's bank account and saw 1 million dollars for the first time!",
    character: 'cfo',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 207,
    description:
      'We just made a witty tweet about Beyonce and she retweeted it.',
    character: 'chad-marketing',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 208,
    description:
      'Verizon wants to feature our product in their newsletter to 50K people.',
    character: 'seo-manager',
    conditions: '',
    choices: {
      a: {
  ...
  },
  {
    id: 210,
    description:
      "We're halfway through the year. We should start thinking about money more.",
    character: 'season-01',
