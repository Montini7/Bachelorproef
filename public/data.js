window.cards = [
	{
		...
		"choices": {
			...
			"b": {
				"label": "B. Je bent fan van Lucas zijn portfolio dus je spendeert 20.000 euro aan een nieuw logo."
			},
			"c": {
	...
	},
	{
		...
		"choices": {
			...
			"b": {
				"label": "B. Je wordt kwaad op Tymo en zegt dat als hij de deadline mist hij ontslagen wordt."
			},
			"c": {
				"label": "C. Je belt naar de klant om de deadline uit te stellen."
			}
		},
		"correctAnswer":{
			"label": "A. Je zoekt een oplossing voor dit probleem en hoort bij de rest van het team of iemand kan helpen met Tymo zijn werk."
	...
	},
	{
		...
		"choices": {
			...
			"b": {
				"label": "B. Je wil onderhandelen met Luc maar je geeft hem geen meerderheid in de raad van bestuur.",
			},
			"c": {
				"label": "C. Je vertelt hem dat je zijn geld niet nodig hebt en dat hij de deal op zijn buik mag schrijven."	
			},
		},
		"correctAnswer":{
				"label": "B. Je wil onderhandelen met Luc maar je geeft hem geen meerderheid in de raad van bestuur."
		...
		"choices": {
			...
			"b": {
				"label": "B. Je laat je favoriete werknemer op reis gaan en dwingt de andere om toch te blijven."
			},
			"c": {
				"label": "C. Je onderhandelt met deze 2 werknemers en voorziet een compensatie voor het rekening houden met het bedrijf."
			}
		...
		"choices": {
			...
			"b": {
				"label": "B. Je stuurt je advocaat op hem af."
			},
			"c": {
				"label": "C. Je contacteert de klant en die geeft een geldige reden voor de refund. Je geeft zijn geld terug als blijk van 'goodwill'."
			}
		...
		"choices": {
			...
			"b": {
				"label": "Je gaat met de klant openbaar in discussie."
			},
			"c": {
				"label": "Je contacteert de klant en probeert het probleem op te lossen."
			}
